...
export default function Login() {
  ...
  return (
    <main className="h-2/3 flex flex-col items-center justify-center px-6 mt-20">
      <div className="w-full sm:w-2/3 lg:w-1/2 xl:w-1/3 min-h-[40%] flex flex-col justify-between items-center bg-light rounded-md ring-1 ring-gray-300 text-dark p-6">
        ...
        <div className="w-full mt-2">
          <Button className="pl-0 focus:ring-0" variant="inlineDark">
            Lupa password ?
          </Button>
        </div>
      </div>
